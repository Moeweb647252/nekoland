...
use nekoland_ecs::resources::{
    CompletedScreenshotFrames, CursorImageSnapshot, CursorSceneSnapshot, DamageState,
    FramePacingState, OutputDamageRegions, PendingScreenshotRequests, RenderMaterialFrameState,
